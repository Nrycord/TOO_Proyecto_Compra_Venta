        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item mx-1">
                    <a class="btn btn-outline-light" href="<?= BASE_DIR; ?>Home/showHome">Inicio</a>
                </li>
                <li class="nav-item mx-1">
                    <a class="btn btn-outline-light" href="<?= BASE_DIR; ?>Home/showHome">Presupuestos</a>
                </li>
                <li class="nav-item mx-1">
                    <a class="btn btn-outline-light" href="<?= BASE_DIR; ?>Home/showHome">Productos</a>
                </li>
                <li class="nav-item mx-1">
                    <a class="btn btn-outline-light" href="<?= BASE_DIR; ?>Home/showHome">Proveedores</a>
                </li>
                <li class="nav-item mx-1">
