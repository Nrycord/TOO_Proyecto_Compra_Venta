    ...
    foreach ($data[TBL_PEDIDOS] as $dato) { 
        echo "<li class='cards_item'>";
            ...
            echo    "<div class='card_content'>";
                ...
                echo    "<hr>";
                echo    "<h2 class='card_title'>Sucursal que está solicitando el pedido:</h2>";
                ...
                echo    "<h2 class='card_title-status'>Cambiar estado:</h2>";
                echo    "<a href=" . BASE_DIR . "Pedido/cambiarEstado&id=". $dato[P_ID] ."&estado=EnProceso"." class='btn'>En proceso</a>";
                echo    "<a href=" . BASE_DIR . "Pedido/cambiarEstado&id=". $dato[P_ID] ."&estado=Realizado"." class='btn'>Realizado</a>";
            echo    "</div>";
            echo "</div>";
        echo "</li>";
    }
